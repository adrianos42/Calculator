...
#[no_mangle]
#[allow(unused_braces)]
pub extern "C" fn static_programmer_commandss(
    value: *const AbiStream,
    _stream: *const AbiStream,
) -> i64 {
    match ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(move || {
        let _ins = super::idl_ffi_impl::ProgrammerStatic::get_instance(|| {
        ...
        let _value_arg_val = {
            ...
            match _value.state.into() {
                AbiStreamSenderState::Waiting => {
                    Box::new(super::idl_ffi_impl::ProgrammerCommandss {
                        callback: unsafe { std::mem::transmute(_value.wake_callback) },
                        handle: _value.wake_handle,
                        object: _value.wake_object,
                    })
                }
                _ => return AbiInternalError::InvalidArg,
            }
        };
        let _stream_val = {
            let _value = unsafe { (_stream as *const AbiStream).read() };
        ...
        _instance.commandss(_value_arg_val, _stream_val);
        return AbiInternalError::Ok;
    })) {
        Ok(value) => value as i64,
        Err(_) => AbiInternalError::UndefinedException as i64,
...
#[no_mangle]
#[allow(unused_braces)]
pub extern "C" fn stream_programmer_commandss(
    _stream: *const AbiStream,
    _stream_result: *mut *mut AbiStream,
) -> i64 {
    match ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(move || {
        let _ins = super::idl_ffi_impl::ProgrammerStatic::get_instance(|| {
            Box::new(super::impl_calc_manager::Programmer::new())
        });
        let _instance = &_ins.instance;
        let _stream_val = unsafe { (_stream as *const AbiStream).read() };
        let _result = _instance.commandss_stream(
            Box::new(super::idl_ffi_impl::ProgrammerCommandss {
                callback: unsafe { std::mem::transmute(_stream_val.wake_callback) },
                handle: _stream_val.wake_handle,
                object: _stream_val.wake_object,
...
#[no_mangle]
#[allow(unused_braces)]
pub extern "C" fn dispose_stream_programmer_commandss(_stream: *mut AbiStream) -> i64 {
    match ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(move || {
        let _stream_val: Box<AbiStream> = unsafe { Box::from_raw(_stream) };
        _stream_val.dispose();
        return AbiInternalError::Ok;
...
#[no_mangle]
#[allow(unused_braces)]
pub extern "C" fn stream_sender_programmer_commandss(
    _stream: *const AbiStream,
    _stream_result: *mut *mut AbiStream,
) -> i64 {
    match ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(move || {
        ...
        let _instance = &_ins.instance;
        let _stream_val = unsafe { (_stream as *const AbiStream).read() };
        let _result = _instance.commandss_stream_sender(
            Box::new(super::idl_ffi_impl::ProgrammerCommandss {
                callback: unsafe { std::mem::transmute(_stream_val.wake_callback) },
                handle: _stream_val.wake_handle,
                object: _stream_val.wake_object,
...
#[no_mangle]
#[allow(unused_braces)]
pub extern "C" fn dispose_stream_sender_programmer_commandss(_stream: *mut AbiStream) -> i64 {
    match ::std::panic::catch_unwind(::std::panic::AssertUnwindSafe(move || {
        let _stream_val: Box<AbiStream> = unsafe { Box::from_raw(_stream) };
        return AbiInternalError::Ok;
    })) {
